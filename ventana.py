...
"}")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("img/printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImprimir.setIcon(icon13)
        self.actionImprimir.setObjectName("actionImprimir")
        self.actionGuardar = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("img/floppy-disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGuardar.setIcon(icon14)
        self.actionGuardar.setObjectName("actionGuardar")
        self.actionAbrir = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("img/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbrir.setIcon(icon15)
        self.actionAbrir.setObjectName("actionAbrir")
        self.actionBuscar = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("img/loupe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBuscar.setIcon(icon16)
